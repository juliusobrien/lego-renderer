...
int main(int argc, char** argv)
{
	...
	//X, Y
	ctrl_points.push_back(point(-5.f, 4.f, 0.f));
	ctrl_points.push_back(point(-3.f, 2.f, 0.f));

	ctrl_points.push_back(point(-2.5f, -3.f, 0.f));
	ctrl_points.push_back(point(-2.5f, -3.f, 0.f));
	ctrl_points.push_back(point(-4.5f, -2.5f, 0.f));
	ctrl_points.push_back(point(-4.5f, -2.5f, 0.f));

	ctrl_points.push_back(point(-1.f, 3.f, 0.f));
	ctrl_points.push_back(point(5.f, 4.f, 0.f));
	...
	float* curve_vertices = MakeFloatsFromVector(curve, num_curve_verts, num_curve_floats, 0.1f, 0.1f, 0.1f);
