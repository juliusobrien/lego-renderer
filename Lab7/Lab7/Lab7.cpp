...
int main(int argc, char** argv)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glUniform3f(glGetUniformLocation(program, "lightColour"), 255.f/255.f, 170.f/255.f, 108.f/255.f); //Incandescent
		//glUniform3f(glGetUniformLocation(program, "lightColour"), 255.f/255.f, 250.f/255.f, 244.f/255.f); //Daylight
		//glUniform3f(glGetUniformLocation(program, "lightColour"), 201.f/255.f, 226.f/255.f, 255.f/255.f); //Star Light
		glUniform3f(glGetUniformLocation(program, "lightColour"), 0.f, 0.f, 1.f); //Blue
